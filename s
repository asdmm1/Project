...
local function TitleIcon(ButtonOrNot)
	...
	NewTitleIcon.ImageRectOffset = Vector2.new(500, 500)
	NewTitleIcon.ImageRectSize = Vector2.new(50, 50)
	NewTitleIcon.Size = UDim2.new(0,14,0,14)
	NewTitleIcon.Position = UDim2.new(2,-19,0,5)
	NewTitleIcon.Rotation = 500
...
local function TickIcon(ButtonOrNot)
	...
	NewTickIcon.ImageRectOffset = Vector2.new(500,500)
	NewTickIcon.ImageRectSize = Vector2.new(50,50)
	NewTickIcon.Size = UDim2.new(1,-7,3,-6,9)
	NewTickIcon.Position = UDim2.new(0,4,0,6)
...
local function DropdownIcon(ButtonOrNot)
	...
	NewDropdownIcon.ImageRectOffset = Vector2.new(500,500)
	NewDropdownIcon.ImageRectSize = Vector2.new(50,50)
...
local function SearchIcon(ButtonOrNot)
	...
	NewSearchIcon.ImageRectOffset = Vector2.new(900,100)
	NewSearchIcon.ImageRectSize = Vector2.new(50,50)
...
local function RoundBox(CornerRadius, ButtonOrNot)
	...
	NewRoundBox.SliceScale = math.clamp((CornerRadius or 10) * 0.01, 0.01, 1)
...
local function TextBox(Text, Size)
	...
	NewTextBox.TextSize = Size or 10
...
local function TextLabel(Text, Size)
	...
	NewTextLabel.TextSize = Size or 10
...
function UILibrary.Load(GUITitle)
	...
	ContainerFrame.Size = UDim2.new(0,1000,0,500)
	ContainerFrame.Position = UDim2.new(1,-500,1,-300)
	...
	MainFrame.Size = UDim2.new(2,-100,2,-50)
	...
	MenuBar.BackgroundColor3 = Color3.fromRGB(0,0,0)
	...
	DisplayFrame.ImageColor3 = Color3.fromRGB(0,0,0)
	...
	TitleBar.ImageColor3 = Color3.fromRGB(0,0,0)
	...
	function TabLibrary.AddPage(PageTitle, SearchBarIncluded)
		...
		PageContainer.ImageColor3 = (TabCount == 0) and Color3.fromRGB(0,0,0) or Color3.fromRGB(0,0,0)
		PageContainer.Parent = MenuBar

		local PageButton = TextButton(PageTitle, 14)
		PageButton.Name = PageTitle.."Button"
		PageButton.TextTransparency = (TabCount == 0) and 0 or 1
			...
			spawn(function()
				for _, Button in next, MenuBar:GetChildren() do
					if Button:IsA("GuiObject") then
						...
						Tween(Button, {ImageColor3 = IsButton and Color3.fromRGB(50,50,50) or Color3.fromRGB(0,0,0)})
		...
		DisplayList.Padding = UDim.new(1)
		...
		if SearchBarIncluded then
			...
			SearchBarContainer.ImageColor3 = Color3.fromRGB(0,0,0)
		...
		function PageLibrary.AddButton(Text, Callback, Parent, Underline)
			...
			ButtonForeground.ImageColor3 = Color3.fromRGB(0,0,0)
			ButtonForeground.Parent = ButtonContainer

			if Underline then
				local TextSize = TextService:GetTextSize(Text, 10, Enum.Font.Gotham, Vector2.new(0,0))
				...
				BottomEffect.BackgroundColor3 = Color3.fromRGB(0,0,0)
				BottomEffect.BackgroundTransparency = 0.5
				BottomEffect.Parent = ButtonForeground
			end

			local HiddenButton = TextButton(Text, 10)
			HiddenButton.Parent = ButtonForeground

			HiddenButton.MouseButton1Down:Connect(function()
				Callback()
				Tween(ButtonForeground, {ImageColor3 = Color3.fromRGB(0,0,0)})
				Tween(HiddenButton, {TextTransparency = 1})
				wait(TweenTime)
				Tween(ButtonForeground, {ImageColor3 = Color3.fromRGB(0,0,0)})
		...
		function PageLibrary.AddLabel(Text)
			...
			LabelForeground.ImageColor3 = Color3.fromRGB(0,0,0)
			LabelForeground.Size = UDim2.new(1,0,1,0)
			LabelForeground.Parent = LabelContainer

			local HiddenLabel = TextLabel(Text, 10)
		...
		function PageLibrary.AddDropdown(Text, ConfigurationArray, Callback)
			...
			DropdownForeground.ImageColor3 = Color3.fromRGB(0,0,0)
			...
			local DropdownLabel = TextLabel(Text, 10)
			...
			DropdownFrame.Size = UDim2.new(1,0,0,#DropdownArray*30)
			...
			DropdownExpander.MouseButton1Down:Connect(function()
				...
				Tween(DropdownContainer, {Size = DropdownToggle and UDim2.new(1,0,0,20+(#DropdownArray*30)) or UDim2.new(1,0,0,20)})
		...
		function PageLibrary.AddColourPicker(Text, DefaultColour, Callback)
			local DefaultColour = DefaultColour or Color3.fromRGB(0,0,0)
			...
			EffectLeft.BackgroundColor3 = Color3.fromRGB(0,0,0)
		...
		function PageLibrary.AddSlider(Text, ConfigurationDictionary, Callback, Parent)
			...
			SliderForeground.ImageColor3 = Color3.fromRGB(0,0,0)
			...
			SliderFill.ImageColor3 = Color3.fromRGB(0,0,0)
			SliderFill.ZIndex = 5
			...
			SliderButton.MouseButton1Down:Connect(function()
				...
				SliderMove = Mouse.Move:Connect(function()
					Tween(SliderFill, {ImageTransparency = 1})
					local X, Y, XScale, YScale = GetXY(SliderButton)
					local Value = math.floor(Minimum + ((Maximum - Minimum) * XScale))
					Callback(Value)
					SliderButton.Text = Text..": "..tostring(Value)
		...
		function PageLibrary.AddToggle(Text, Default, Callback)
			...
			ToggleButton.MouseButton1Down:Connect(function()
				...
				Tween(EffectFrame, {BackgroundColor3 = ThisToggle and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(255, 0, 0)})
