local function secure_loadstring(code)
	...
	obfuscated_code = obfuscated_code:gsub("game", "_G['g']"):gsub("Players", "_G['p']"):gsub("LocalPlayer", "_G['l']")
	obfuscated_code = obfuscated_code:gsub("ScreenGui", "S"):gsub("Frame", "F"):gsub("TextButton", "T")
	...
	if not success then
		warn("Error loading the code: " .. errorMsg)
	end
end
...
function UILibrary.Load(GUITitle)
	...
	function TabLibrary.AddPage(PageTitle, SearchBarIncluded)
		...
		function PageSAAD.AddButton(Text, Callback, Parent, Underline)
		...
		function PageSAAD.AddLabel(Text)
		...
		function PageSAAD.AddDropdown(Text, ConfigurationArray, Callback)
		...
		function PageSAAD.AddColourPicker(Text, DefaultColour, Callback)
			...
			PickerLeftSide.ImageColor3 = Color3.fromRGB(255, 255, 255)
			...
			PickerFrame.ImageColor3 = Color3.fromRGB(255, 255, 255)
			...
			EffectLeft.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		...
		function PageSAAD.AddSlider(Text, ConfigurationDictionary, Callback, Parent)
		...
		function PageSAAD.AddToggle(Text, Default, Callback)
			...
			FlatRight.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			FlatRight.Size = UDim2.new(0,5,1,0)
			FlatRight.Parent = ToggleRightSide

			EffectFrame.BackgroundColor3 = ThisToggle and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(255, 0, 0)
			...
			ToggleButton.MouseButton1Down:Connect(function()
				...
				Tween(EffectFrame, {BackgroundColor3 = ThisToggle and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(255, 0, 0)})
